...
function OrgNewEvent() {
    ...
    async function submit(e) {
        ...
        try {
            ...
            await axios.post("http://localhost:8000/orgnewevent", {
                username, eventName, venue, price, capacity, booked, aboutEvent
            })
                .then(res => {
                    if (res.data == "exist") {
    ...
    return (
        <div>
            <h1>Hello {location.state.id} and welcome to the new event page</h1>
            ...
            <div className="sidenav">
                ...
                <a href="/orgnewevent" id="newevent">New Event</a>
